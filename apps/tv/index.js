...
import { tareaDeTele } from './src/teles';
...
// Y la de "Ver en la tele", por lo mismo: el nombre es el de
// `ServicioDeTele.TAREA`.
AppRegistry.registerHeadlessTask('tele', () => tareaDeTele);
